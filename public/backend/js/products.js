...
jQuery(function () {
  ...
  $(document).on("click", ".open-close-panel", function (e) {
    ...
    if ($(this).html() == '<i class="fa fa-plus"></i> Expand') {
      $(this).html('<i class="fa fa-minus"></i> d-none');
      return;
    }

    if ($(this).html() == '<i class="fa fa-minus"></i> d-none') {
  ...
  $("#apartment-type").on("change", function () {
    ...
    if ($self.val() === "single") {
      $(".simple-apartment").removeClass("d-none");
      $(".variation-panel").addClass("d-none");
      $(".new-room").addClass("d-none");
    } else {
      $(".simple-apartment").addClass("d-none");
      $(".new-room").removeClass("d-none");
      $(".variation-panel").removeClass("d-none");
    }
  });
