        ...
        <div class="card">
            <form id="register" method="POST" action="{{ route('admin.users.update', ['user' => $user->id ]) }}">
                ...
                <div class="card card-login card-hidden">
                    ...
                    <div class="card-content px-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group label-floating">
                                    ...
                                    <input id="Phone" type="text" class="form-control{{ $errors->has('phone_number') ? ' is-invalid' : '' }}" name="phone_number" value="{{ $user->phone_number }}" autofocus>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="permission_id" required="true" class="form-select">
                    ...
                    <div class="footer  pull-right mt-4 ml-4">
                        <button type="submit" name="admin" value="submit" class="btn btn-primary  btn-wd btn-lg py-2 mr-4">Submit</button>
                    </div>
                </div>
            </form>
        </div>
