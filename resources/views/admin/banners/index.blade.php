...
<div class="row">
    <div class="col-md-12">
        <div class="text-right d-flex justify-content-end mb-2">
            ...
            <a href="{{ route('banners.create') }}" rel="tooltip" title="Add New" class="btn btn-primary btn-sm mr-1">
                + Add Banner
            </a>

            <button type="button" data-toggle="tooltip" title="Delete" class="btn btn-primary btn-sm mr-1" onclick="confirm('Are you sure?') ? $('#form-banner').submit() : false;"><i class="fa fa-trash-o"></i>
                Delete
            </button>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="img-container">
                                            <img height="100" width="100" src="{{ $banner->image }}" alt="...">
                                        </div>
                                    </td>
                                    <td class="td-name">
                                    ...
                                    <td class="td-actions">
                                        <a href="{{ route('banners.edit',['banner'=>$banner->id])  }}" class="btn btn-simple btn-warning btn-icon edit mb-0">Edit</a>
                                    </td>
                                </tr>
                                @endforeach
                                @endif
