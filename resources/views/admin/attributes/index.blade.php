                ...
                <div class="d-flex justify-content-between">
                    <div class="checkbox col-md-6 text-left">
                        <label class="cursor-pointer">
                            <input onclick="$('input[name*=\'selected\']').prop('checked', this.checked);" type="checkbox" class="cursor-pointer" name="optionsCheckboxes"> Select All
                        </label>
                    </div>
                    <div class="col-md-6 text-end">
                        <a href="javascript:void(0)" onclick="confirm('Are you sure?') ? $('#form-attribute').submit() : false;" rel="tooltip" title="Remove" class="text-danger text-sm">
                            Delete
                        </a>
                    </div>
                </div>
                            ...
                            <div class="parent" value="{{ $attribute->id }}">
                                <div class="checkbox">
                                    <label>
                                        ...
                                        <strong>{{ $attribute->name }}</strong> <a class="text-primary" href="{{ route('attributes.edit',['attribute'=>$attribute->id]) }}"><i class="fa fa-pencil"></i> Edit</a>
                                    </label>
                                </div>
